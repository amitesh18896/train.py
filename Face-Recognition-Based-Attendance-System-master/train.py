...
window.title("SGVU-This Project Created By Amitesh Mishra")
...
message = tk.Label(window, text="welcome to smart college sgvu" ,bg="Green"  ,fg="white"  ,width=50  ,height=3,font=('times', 30, 'italic bold underline'))
...
copyWrite.insert("insert", "Developed by Amitesh mishra","", "TEAM", "superscript")
